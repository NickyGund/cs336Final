...
<body>
	...
	<%
		try {
			...
			String new_flight_id = request.getParameter("flight_id");
			...
			String update = "UPDATE Ticket SET flight_id = ?, round_trip = ?, booking_fee = ?, total_fare = ?, issue_date = ? WHERE ticketNum = ?";
			//Create a Prepared SQL statement allowing you to introduce the parameters of the query
			PreparedStatement ps = con.prepareStatement(update);

			//Add parameters of the query. Start with 1, the 0-parameter is the INSERT statement itself
			ps.setString(1, new_flight_id);
			ps.setString(2, new_round_trip);
			ps.setString(3, new_booking_fee);
			ps.setString(4, new_total_fare);
			ps.setString(5, new_issue_date);
